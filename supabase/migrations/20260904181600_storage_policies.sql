-- Storage policies for audio-files and background-music buckets.
-- Not captured by 'supabase db pull' (dumps public schema only).
-- Consolidated from supabase-audio-files-storage-policies.sql and
-- supabase-music-storage-policies.sql during repo restructure.
